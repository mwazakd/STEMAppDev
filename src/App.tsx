...
function App() {
  ...
  const [useGlassmorphismBurette, setUseGlassmorphismBurette] = useState(false) // Toggle for glassmorphism burette
  ...
  // Use the glassmorphism burette if enabled
  if (useGlassmorphismBurette) {
    return (
      <div>
        <div style={{
          position: 'absolute',
          ...
          <button
            onClick={() => {
              setUseGlassmorphismBurette(false);
    ...
    return (
      <div>
        <div style={{
          ...
          <button
            onClick={() => setUseGlassmorphismBurette(true)}
            style={{
